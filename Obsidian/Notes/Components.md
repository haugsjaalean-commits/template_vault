...
> N.B. I changed my mind about the name of the new base characteristic. I think that it should be called `component fields` instead of `components`, because this more accurately explains the purpose of the field. 
